    ...
    internal class Program
    {
        public class ContoCorrente
        {
            ...
            public void MenuInizialeStart()
            {
                ...
                Console.WriteLine("==========================================");
                Console.WriteLine("I N T E S A   S A N   PAOLO   B A N K");
                Console.WriteLine("==========================================");
            ...
            private void EffettuaPrelevamento()
            {
                ...
                {
                    Console.WriteLine("DEVI APRIRE IL CONTO PRIMA");
                }
                else
                {
                    ...
                    {
                        Console.WriteLine("Prelievo NEGATO!!!");
                    }
                    else
                    {
            ...
            private void EffettuaVersamento()
            {
                ...
                else
                {
                    ...
                    Console.WriteLine($"Nuovo saldo del CC: {_saldo.ToString("N")}");
                }
                MenuInizialeStart();
            }
        ...
        static void Main(string[] args)
        {
            ...
            contoCorrente.MenuInizialeStart();
        }
    }
}
